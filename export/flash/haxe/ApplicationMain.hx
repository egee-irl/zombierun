...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("ZombieRun", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("ZombieRun", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "ZombieRun";
		app.meta["name"] = "ZombieRun";
	...
	macro public static function getPreloader () {
			...
			case TInst (classType, _):
				...
				while (searchTypes != null) {
					...
					if (searchTypes.pack.length == 2 && searchTypes.pack[0] == "openfl" && searchTypes.pack[1] == "display" && searchTypes.name == "Preloader") {
						...
						return macro { new flixel.system.FlxPreloader (); };
		...
		return macro { new openfl.display.Preloader (new flixel.system.FlxPreloader ()); }
